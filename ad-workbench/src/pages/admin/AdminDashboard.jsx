...
const tabs = [
  ...
  { key: 'api-settings', label: 'API 配置', icon: <KeyRound size={14} /> },
...
function TabApiSettings() {
  ...
  const saveConfig = async () => {
    setBusy(true);
    setFeedback('');
    const payload = { ...config, keep_existing_api_key: true };
    try {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="api-settings-hero">
        <div>
      ...
      <div className="api-settings-grid">
        <div className="card api-settings-main">
          ...
          <div className="card-body">
            <div className="api-form-stack">
              ...
              {feedback && <div className="api-settings-feedback">{feedback}</div>}
            </div>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="card-body">
            <div className="api-settings-status">
              {statusItems.map((item) => (
                <div className="api-settings-status-row" key={item.label}>
